...
import requests
# P:\StudyWork\PythonProg\Web_scrapping
# create a new Firefox session in chrome using chromedriver
req = webdriver.Chrome(executable_path='P:/StudyWork/Python Programs/PythonProg/Web_scrapping/zomato/chromedriver')#must be the chromedriver in this specified folder
